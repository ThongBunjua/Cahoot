...
/**
 * ==============================================================================================
 * ⏱️ CAHOOT! LAST-5-SECONDS RUSH STRESS TEST BOT SIMULATOR (NATIVE NODE ENGINE)
 * ==============================================================================================
 * 
 * 📖 วิธีรัน:
 *    node scratch/stress-test-last-5s.mjs <GAME_PIN> <จำนวนบอท>
 *    หรือ: npm run bot:last5s <GAME_PIN> <จำนวนบอท>
 * 
 * ==============================================================================================
 */
...
async function runLast5SecondsRushSimulation() {
  ...
  console.log(`=============================================================`);
  console.log(`⏳ Connecting to Supabase Realtime for PIN ${targetPin}...`);
