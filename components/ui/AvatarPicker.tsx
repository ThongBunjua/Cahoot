...
export const AVATARS = [
  ...
  "🦍", "🦩", "🦋", "🦇", "🦎", "🐢", "🐧", "🦔",
  "🐆", "🦓", "🦌", "🦘", "🦭", "🦦", "🦥", "🐝",
  // Cosmic, Gaming, Magic & Hero Badges
  "👑", "💎", "⚡", "🔥", "🌟", "🚀", "🪐", "🏆",
  "🎮", "👾", "🤖", "🛡️", "⚔️", "🎯", "🔮", "🍀",
  "☀️", "🌙", "☄️", "⚓", "🛸", "🕹️", "🎪", "🎭",
  "🎨", "🎧", "🎬", "🛹", "🧩", "🎲", "🌋", "🎆"
...
export function AvatarPicker({ selectedAvatar, onSelect }: AvatarPickerProps) {
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-8 gap-2 p-3 bg-[#33106B] rounded-2xl border-2 border-[#240B4D] shadow-inner max-h-[220px] overflow-y-auto">
        {AVATARS.map((avatar) => {
          ...
          return (
            <motion.button
              ...
              className={`aspect-square text-2xl sm:text-3xl rounded-xl transition-all flex items-center justify-center cursor-pointer border ${
                isSelected
